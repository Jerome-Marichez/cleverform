...
| `systeme/backend/ai-generate.cy.ts` | système | **Chemin IA réel** (Anthropic Haiku 4.5) : génération d'un questionnaire persisté + correction de texte ; assertions structurelles, skip propre si l'IA est indisponible — clé **absente ou invalide** (503) |
