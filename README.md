...
- [Bottlenecks & axes d'amélioration](./docs/ameliorations.md) — goulots (IA coût/latence, rate limiting, scalabilité des réponses), **observabilité** (quasi inexistante hors Vercel → Sentry + alertes), **déploiement & packaging** (monolithe vs découpage, Vercel/GCP/self-hosted, extraction npm) et pistes proposées.
